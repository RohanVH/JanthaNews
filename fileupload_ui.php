...
<body>
    ...
    <div class="container" role="main">
        ...
        <nav role="navigation" class="text-danger">
            <h1 class="is-selected" style="cursor:pointer;"><u>UPLOAD FILES</u></h1>
        </nav>
        ...
        <form action="upload.php" method="post" enctype="multipart/form-data" class="box">
            ...
            <div class="box__input">
                ...
                <input type="file" name="myfile" id="file" class="btn btn-danger" data-multiple-caption="{count} files selected" multiple />
                <br>
                <label for="file">
                    <br>
    ...
    <br>
    <br>
    <div class="d-flex justify-content-center border border-3 border-danger rounded-pill text-light" style="background-color:black;border-style: ridge;border-width: thick;">
