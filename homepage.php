...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row align-items-center py-2 px-lg-5">
            ...
            <div class="col text-lg-right">
                ...
                <img src="img/darkicon.png" onclick="myFunction()" id="dark" />
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 mb-5">
                <a href="index.html" class="navbar-brand">
                    <h1 class="mb-2 mt-n2 display-5 text-uppercase"><span class="text-primary">News</span>Jantha</h1>
                </a>
    ...
    <div class="container-fluid py-4 px-sm-3 px-md-5">
        <p class="m-0 text-center">
            ...
            Designed by <a class="font-weight-bold" href="https://htmlcodex.com">Dword Core</a>
        </p>
    </div>
    <!-- Footer End -->
