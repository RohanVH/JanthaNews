    ...
    <div class="container-fluid">
        <div class="container">
            <nav class="breadcrumb bg-transparent m-0 p-0">
                <a class="breadcrumb-item" href="homepage.php">Home</a>
                    ...
                    <div class="bg-light mb-3" style="padding: 30px;">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="d-flex flex-column">
                                <p class="m-0">
                                    pappareddypalya circle opposite muthoot finance Nagarbhavi 2<sup>nd</sup> stage Bangalore-560072.
                                    <!-- add office address -->
                                </p>
                            </div>
                        </div>
